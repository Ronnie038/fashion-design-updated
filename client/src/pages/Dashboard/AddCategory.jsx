...
const AddCategory = () => {
	return (
		<div className='w-11/12 mx-auto'>
			<h2 className='text-3xl my-8 font-semibold'>AddCategory & Return </h2>
			...
			<div className='mt-6 flex gap-6'>
				<div className='w-full'>
					<div className='w-full'>
						<label className='text-xl font-semibold'>AddCategory Process</label>
					...
					<div className='w-full'>
						<div className='flex mt-3 border'>
							...
							/>
							<div className='text-2xl flex justify-center items-center'>
								<button className='btn bg-transparent text-red-700 rounded-none hover:bg-red-700 hover:text-white'>
									<Icon icon='fluent-mdl2:delete' className='text-xl' />
								</button>
							</div>
						</div>
					</div>
